...
tags: ["c#", "csharp", "dotnet", ".NET", "asp.net"]
---
...
<Tabs>
  <Tab name="Postgres">
    ...
    <Instruction>
      Create a new `DatabaseContext.cs` file in your `Models` directory to manage your database
      connection.
    </Instruction>
...
{" "}
<Instruction>
  Create a new `DatabaseContext.cs` file in your `Models` directory to manage
...
```
      ...
      ```
      <Note>
    If you're using the InMemory database, you don't need to worry about the env var or migration sections below.
    </Note>
...
<Tabs>
  ...
  <Tab name="Controllers">
    ...
    public class TodosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IQueryable<Todo>>> GetTodoItems()
        {
            return await _context.Todos.ToListAsync();
        }

        [HttpGet("complete")]
        public async Task<ActionResult<IQueryable<Todo>>> GetCompletedTodoItems()
        {
