---
id: 8aff1ca7-64d6-408e-b7fc-3200a28c9c00
wp_id: 689
title: 'Dependency Injection in JavaScript'
date: '2021-04-01T08:50:14'
slug: 'dependency-injection-in-javascript'
image: 'dependency-injection-in-javascript.png'
status: 'published'
description: 'There are a few benefits to using dependency injection, but the best, most useful benefit and biggest reason to use dependency injection is to make your code more testable. In this article we’re going to take a look at what dependency injection is by using an example of an express app that stores data in \[…\]'
tags: []
---
